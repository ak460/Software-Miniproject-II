...
<html lang="en">
    ...
    <body>
        ...
        <div class="mn-content fixed-sidebar">
                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">      
                            <span class="chapter-title">SMS | Staff Management System</span>
                        </div>
          ...
          <div class="footer">
                    <p class="copyright">SMS©Akanksha Desai & Haripriya Saraswat</p>
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h4>Welcome to Staff Management System</h4></div>
